...
var Size = {
    ...
    calc: function () {
        ...
        dist.x.wall_belt_inner = nema.side_size / 2 + Size.gt2_pulley.belt_ro - belt.thickness;
...
// cube located as a cylinder.
function ccube (_args_) {
    var c = cube (_args_);
...
var motor_mount = {
    ...
    mesh: function () {
        ...
        return difference (
            ...
            cube({size: [20, 20, 20]})
                .translate([_nemaXYZ / 2, _nemaXYZ / 2 - 20 + nema.ring_r + Size.clr.free, -1]),
            // round
